...
from inclearn.models.icarl import ICarl, tensor_inv

from inclearn.utils import LOGGER as logger
from inclearn.lib.utils import check_loss
from inclearn.lib.losses.vat import VATLoss
...
from inclearn.lib.losses.SoftEntropy import SoftEntropy
from inclearn.lib.losses.RKD import RkdDistance, RKdAngle
...
class Imagine(ICarl):
            ...
            if split:
                ...
                for idx, tar in enumerate(mixed_targets):
                    ...
                    if len(labeled_logits) > 1:
                        ...
                        soft_targets_cls = labeled_logits
    ...
    def _after_task_intensive(self, inc_dataset, train_generator=False):
        if self._task == self._n_tasks - 1 or not self._use_unlabeled:
