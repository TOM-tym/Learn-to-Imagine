...
class AuxSampler(BatchSampler):
    def __init__(self, y, batch_size, n_sample):
    ...
    def point_current_classes(self, current_classes):
    ...
    def __iter__(self):
        while True:
            ...
            if len(self.current_classes):
                candidate_cls = np.random.choice(self.current_classes, min(n_classes, len(self.current_classes)),
                                                 replace=False)
