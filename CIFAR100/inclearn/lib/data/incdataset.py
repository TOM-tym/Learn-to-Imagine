...
from inclearn.lib.data.samplers import AuxSampler
...
class IncrementalDataset:
    ...
    def new_task(self, memory=None, pseudo_memory=None, memory_val=None, pseudo_memory_usage='mixed',
        ...
        aux_loader = DataLoader(self.aux_data, batch_size=self._batch_size, num_workers=self._workers, shuffle=False,
                                drop_last=False)
        task_info = {
            "min_class": min_class,
            "max_class": max_class,
    ...
    def get_pseudo_memory_loader(self, pseudo_memory, pseudo_memory_n_samples, batch_size):
